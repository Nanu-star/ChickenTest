...
<c:url var="home" value="GranjaControlador">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="container">
		  ...
		  <a class="nav-link" href="${logOut}" onclick="if (!(confirm('Estas seguro cerrar la sesión?'))) return false"><button type="button" class="btn btn-light">Salir</button></a>
	  </div>
    </nav>
<!-- NAV -->
	<div class="container col-6">
	<h3 class="d-flex justify-content-center"> Comprar Articulo </h3>
	<br/>
	
		<form action="GranjaControlador" method="GET">
					<input type="hidden" name="command" value="COMPRA"/>
					...
					<div class="d-flex justify-content-center">
						<input class="btn btn-primary" type="submit" value="Seleccionar" onclick="if (!(confirm('Desea confirmar esta compra?'))) return false"/>
					</div>
					<br/>
